...
from socorro_lib.task_manager import respond_to_SIGTERM
from socorro_lib.app.generic_app import App, main  # main not used here, but
...
class FetchTransformSaveApp(App):
    ...
    required_config.producer_consumer.add_option(
      ...
      default='socorro_lib.threaded_task_manager.ThreadedTaskManager',
      from_string_converter=class_converter
    )
